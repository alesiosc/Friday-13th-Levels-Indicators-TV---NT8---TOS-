    ...
    public class NT8_Friday13th_Levels : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                AllData          = "";
                Set3Data         = "";
                FullLevelsFilePath = @"C:\Users\Cameron\Documents\NinjaTrader 8\bin\Custom\Indicators\levels.txt";
                ...
                ZuluLineOpacity = 100; ZuluLineWidth = 2; ZuluLineStyle = DashStyleHelper.Dash; ZuluLabelAnchor = LabelAnchorPosition.Right;
        ...
        private void ProcessAndDrawLevels()
        {
            ...
            if (!string.IsNullOrWhiteSpace(parsedZulu))
                DrawZulu(parsedZulu, startTime, endTime);
        ...
        private int GetLabelBarsAgoForAnchor(LabelAnchorPosition anchor, int totalBars)
        {
            switch (anchor)
            {
                case LabelAnchorPosition.Left:
                ...
                case LabelAnchorPosition.Middle:
                    return Math.Min(250, CurrentBar);
                default:
                    return 0;
            }
        }
            ...
            DateTime startTime, DateTime endTime)
        {
            ...
            foreach (string z in rawData.Split(';'))
            {
                ...
                if (showLabels)
                {
                    ...
                    Draw.Text(this, "S1LB_" + symbol + "_" + pTop.ToString("F2"), false, fullText, GetLabelBarsAgoForAnchor(S1LabelAnchor, CurrentBar), mid, 0, S1LabelTextColor, font, GetTextAlignment(S1LabelAnchor), S1LabelBG, Brushes.Transparent, 0);
            ...
            foreach (string seg in rawData.Split(';'))
            {
                ...
                if (trimmed.Contains(","))
                {
                    ...
                    if (showLabels)
                    {
                        ...
                        Draw.Text(this, "S2LB_" + symbol + "_" + top.ToString("F2"), false, lblStr, GetLabelBarsAgoForAnchor(S2LabelAnchor, CurrentBar), midp, 0, S2LabelTextColor, font, GetTextAlignment(S2LabelAnchor), S2LabelBG, Brushes.Transparent, 0);
                ...
                else
                {
                    ...
                    if (showLabels)
                    {
                        ...
                        var font = GetFont(S2LabelSize);
                        Draw.Text(this, "S2LB_" + symbol + "_" + level.ToString("F2"), false, lblStr, GetLabelBarsAgoForAnchor(S2LabelAnchor, CurrentBar), level, 0, S2LabelTextColor, font, GetTextAlignment(S2LabelAnchor), S2LabelBG, Brushes.Transparent, 0);
        ...
        private void DrawSet3(string symbol, DateTime startTime, DateTime endTime)
        {
            ...
            if (parsedMid.HasValue)
            {
                ...
                if (S3ShowKeyLabels)
                {
                    ...
                    Draw.Text(this, "S3ML_" + symbol, false, "Mid", GetLabelBarsAgoForAnchor(S3LabelAnchor, CurrentBar), parsedMid.Value, -14, S3LabelTextColor, font, GetTextAlignment(S3LabelAnchor), S3LabelBG, Brushes.Transparent, 0);
            ...
            if (parsedLower.HasValue)
            {
                ...
                {
                    var font = GetFont(S3LabelSize);
                    Draw.Text(this, "S3LL_" + symbol, false, "Lower", GetLabelBarsAgoForAnchor(S3LabelAnchor, CurrentBar), parsedLower.Value, -14, S3LabelTextColor, font, GetTextAlignment(S3LabelAnchor), S3LabelBG, Brushes.Transparent, 0);
            ...
            if (parsedUpper.HasValue)
            {
                ...
                {
                    var font = GetFont(S3LabelSize);
                    Draw.Text(this, "S3UL_" + symbol, false, "Upper", GetLabelBarsAgoForAnchor(S3LabelAnchor, CurrentBar), parsedUpper.Value, -14, S3LabelTextColor, font, GetTextAlignment(S3LabelAnchor), S3LabelBG, Brushes.Transparent, 0);
            ...
            DateTime startTime, DateTime endTime)
        {
            ...
            foreach (string seg in rawData.Split(';'))
            {
                ...
                if (showLabels)
                {
                    ...
                    Draw.Text(this, "S4LB_" + symbol + "_" + level.ToString("F2"), false, lbl, GetLabelBarsAgoForAnchor(S4LabelAnchor, CurrentBar), level, -14, S4LabelTextColor, font, GetTextAlignment(S4LabelAnchor), S4LabelBG, Brushes.Transparent, 0);
            ...
            DateTime startTime, DateTime endTime)
        {
            ...
            foreach (string z in rawData.Split(';'))
            {
                ...
                if (showLabels)
                {
                    ...
                    Draw.Text(this, "S5LB_" + symbol + "_" + pTop.ToString("F2"), false, fullText, GetLabelBarsAgoForAnchor(S5LabelAnchor, CurrentBar), mid, 0, S5LabelTextColor, font, GetTextAlignment(S5LabelAnchor), S5LabelBG, Brushes.Transparent, 0);
            ...
            DateTime startTime, DateTime endTime)
        {
            ...
            foreach (string z in rawData.Split(';'))
            {
                ...
                if (showLabels)
                {
                    ...
                    Draw.Text(this, "S6LB_" + symbol + "_" + pTop.ToString("F2"), false, fullText, GetLabelBarsAgoForAnchor(S6LabelAnchor, CurrentBar), mid, 0, S6LabelTextColor, font, GetTextAlignment(S6LabelAnchor), S6LabelBG, Brushes.Transparent, 0);
            ...
            DateTime startTime, DateTime endTime)
        {
            ...
            foreach (string z in rawData.Split(';'))
            {
                ...
                if (showLabels)
                {
                    ...
                    Draw.Text(this, "S7LB_" + symbol + "_" + pTop.ToString("F2"), false, fullText, GetLabelBarsAgoForAnchor(S7LabelAnchor, CurrentBar), mid, 0, S7LabelTextColor, font, GetTextAlignment(S7LabelAnchor), S7LabelBG, Brushes.Transparent, 0);
            ...
            foreach (string seg in rawData.Split(';'))
            {
                ...
                if (trimmed.Contains(","))
                {
                    ...
                    if (showLabels)
                    {
                        ...
                        Draw.Text(this, "LISLB_" + t.ToString("F2"), false, "LIS", GetLabelBarsAgoForAnchor(LISLabelAnchor, CurrentBar), mid, -14, LISLabelTextColor, font, GetTextAlignment(LISLabelAnchor), LISLabelBG, Brushes.Transparent, 0);
                ...
                else
                {
                    ...
                    {
                        var font = GetFont(LISLabelSize);
                        Draw.Text(this, "LISLB_" + level.ToString("F2"), false, "LIS", GetLabelBarsAgoForAnchor(LISLabelAnchor, CurrentBar), level, -14, LISLabelTextColor, font, GetTextAlignment(LISLabelAnchor), LISLabelBG, Brushes.Transparent, 0);
        ...
        // =====================================================================
        private void DrawZulu(string rawData, DateTime startTime, DateTime endTime)
        {
            IFormatProvider fp = System.Globalization.CultureInfo.InvariantCulture;
            ...
            foreach (string seg in rawData.Split(';'))
            {
                ...
                if (trimmed.StartsWith("Zulu VOL-", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    if (ZuluShowLabels)
                    {
                        ...
                        Draw.Text(this, "ZVOLUL_" + upper.ToString("F2"), false, "VOL Upper", GetLabelBarsAgoForAnchor(ZuluLabelAnchor, CurrentBar), upper, -14, ZuluLabelTextColor, font, GetTextAlignment(ZuluLabelAnchor), ZuluLabelBG, Brushes.Transparent, 0);
                    ...
                    {
                        var font = GetFont(ZuluLabelSize);
                        Draw.Text(this, "ZVOLLL_" + lower.ToString("F2"), false, "VOL Lower", GetLabelBarsAgoForAnchor(ZuluLabelAnchor, CurrentBar), lower, -14, ZuluLabelTextColor, font, GetTextAlignment(ZuluLabelAnchor), ZuluLabelBG, Brushes.Transparent, 0);
                ...
                else if (trimmed.StartsWith("Zulu OI-", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    {
                        var font = GetFont(ZuluLabelSize);
                        Draw.Text(this, "ZOIUL_" + upper.ToString("F2"), false, "OI Upper", GetLabelBarsAgoForAnchor(ZuluLabelAnchor, CurrentBar), upper, -14, ZuluLabelTextColor, font, GetTextAlignment(ZuluLabelAnchor), ZuluLabelBG, Brushes.Transparent, 0);
                    ...
                    {
                        var font = GetFont(ZuluLabelSize);
                        Draw.Text(this, "ZOILL_" + lower.ToString("F2"), false, "OI Lower", GetLabelBarsAgoForAnchor(ZuluLabelAnchor, CurrentBar), lower, -14, ZuluLabelTextColor, font, GetTextAlignment(ZuluLabelAnchor), ZuluLabelBG, Brushes.Transparent, 0);
                ...
                else if (trimmed.StartsWith("Zulu Gamma Flip-", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    {
                        var font = GetFont(ZuluLabelSize);
                        Draw.Text(this, "ZGFL_" + level.ToString("F2"), false, "Gamma Flip", GetLabelBarsAgoForAnchor(ZuluLabelAnchor, CurrentBar), level, -14, ZuluLabelTextColor, font, GetTextAlignment(ZuluLabelAnchor), ZuluLabelBG, Brushes.Transparent, 0);
        ...
        [Display(Name = "Show Zones",  GroupName = "S1 Style", Order = 10)]  public bool S1ShowZones  { get; set; }
        [Display(Name = "Show Labels", GroupName = "S1 Style", Order = 11)]  public bool S1ShowLabels { get; set; }
        [Display(Name = "Show Zones",  GroupName = "S2 Style", Order = 10)]  public bool S2ShowZones  { get; set; }
        [Display(Name = "Show Labels", GroupName = "S2 Style", Order = 11)]  public bool S2ShowLabels { get; set; }
        ...
        [Display(Name = "Show Zones",  GroupName = "S5 Style", Order = 10)] public bool S5ShowZones  { get; set; }
        [Display(Name = "Show Labels", GroupName = "S5 Style", Order = 11)] public bool S5ShowLabels { get; set; }
        [Display(Name = "Show Zones",  GroupName = "S6 Style", Order = 10)] public bool S6ShowZones  { get; set; }
        [Display(Name = "Show Labels", GroupName = "S6 Style", Order = 11)] public bool S6ShowLabels { get; set; }
        [Display(Name = "Show Zones",  GroupName = "S7 Style", Order = 10)] public bool S7ShowZones  { get; set; }
        [Display(Name = "Show Labels", GroupName = "S7 Style", Order = 11)] public bool S7ShowLabels { get; set; }
